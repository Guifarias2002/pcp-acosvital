...
const SETOR_ICONS: Record<string, string> = {
  ...
  conferencia_hrm: 'bi-clipboard-check',
  recebimento_hrm: 'bi-box-arrow-in-down',
  logistica: 'bi-truck',
  ...
  cald_pre_montagem: 'bi-bricks',
  cald_insp_fitup: 'bi-bullseye',
  cald_insp_terceiros: 'bi-patch-check',
  cald_montagem_interm: 'bi-bricks',
  cald_montagem_final: 'bi-box-seam',
  cald_insp_visual: 'bi-eye',
  cald_insp_lp: 'bi-droplet',
  cald_insp_pm: 'bi-magnet',
  cald_insp_us: 'bi-soundwave',
  cald_insp_dimensional: 'bi-rulers',
  cald_tipagem: 'bi-type',
  cald_conj_insp_cliente: 'bi-diagram-3',
  cald_insp_dim_cliente: 'bi-rulers',
  cald_teste_carga: 'bi-speedometer2',
  cald_teste_queda: 'bi-arrow-down-circle',
  cald_lab_externo: 'bi-eyedropper',
  cald_insp_pintura: 'bi-palette',
  cald_insp_final_cliente: 'bi-person-check',
  cald_book_insp_cliente: 'bi-journal-check',
  cald_book_postagem: 'bi-cloud-upload',
  cald_book_ag_aprov: 'bi-hourglass-split',
  cald_book_aprovado: 'bi-journal-bookmark-fill',
};
