...
export async function POST(req: Request) {
  ...
  try {
    ...
    const [user] = await sql`
      SELECT id, username, password, nome, is_staff, is_active, perfil, setor, setores, somente_leitura, ve_todos_pedidos, pode_desfazer_recebimento, pode_ver_analise, acesso_hrm
