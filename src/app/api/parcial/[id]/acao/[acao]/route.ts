...
const ACOES_VALIDAS = ['mover', 'iniciar', 'concluir', 'cancelar', 'apontar'] as const;
...
export async function POST(
  ...
  // Parciais concluídas ou canceladas não aceitam mais ações (exceto verificação)
  if (['concluida', 'cancelada'].includes(parcial.status) && acao !== 'apontar')
